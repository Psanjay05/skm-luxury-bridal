...
export const INITIAL_BOOKINGS = [
  {
    ...
    bookingReference: "SKM-2026-84920",
    customerName: "Priya Dharshini",
    phone: "9842712345",
    email: "priya.bride@gmail.com",
    service: "Royal HD Makeover Package",
    preferredDate: "2026-09-15",
    preferredTime: "04:30 AM (Muhurtham)",
    location: "Grand Palace Mahal, Fairlands, Salem",
    message: "Need 2 event looks (Muhurtham + Reception) with flower jada & saree box pleating.",
    status: "confirmed",
    isDeleted: false,
  ...
  },
  {
    ...
    bookingReference: "SKM-2026-72819",
    customerName: "Soundarya R.",
    phone: "9443298765",
    email: "soundarya.r@gmail.com",
    service: "Luxury Airbrush Grand Package",
    preferredDate: "2026-09-28",
    preferredTime: "05:30 PM (Reception Glam)",
    location: "Sona Convention Centre, Salem",
    message: "Airbrush waterproof base required for heavy mandap heat.",
    status: "pending",
    isDeleted: false,
  ...
  },
  {
    ...
    bookingReference: "SKM-2026-31945",
    customerName: "Keerthana Murali",
    phone: "8608194233",
    email: "keerthana.m@gmail.com",
    service: "Classic Bridal Package",
    preferredDate: "2026-10-05",
    preferredTime: "08:30 AM (Morning Function)",
    location: "SKM Studio, Steel Plant Road, Salem",
    message: "HD foundation with traditional South Indian braid extensions.",
    status: "pending",
    isDeleted: false,
...
export const INITIAL_MESSAGES = [
  {
    ...
    phone: "9944512340",
    message: "Inquiry about bridal makeover slot for November 12th Muhurtham in Salem. Do you also provide saree pre-pleating and jewellery on rent?",
    status: "unread",
    isDeleted: false,
  ...
  },
  {
    ...
    name: "Kausalya Devi",
    email: "kausalya.dev@gmail.com",
    phone: "9876543210",
    message: "Looking for antique Lakshmi temple jewellery set rental for reception. Please send rental details and trial timings.",
    status: "read",
    isDeleted: false,
