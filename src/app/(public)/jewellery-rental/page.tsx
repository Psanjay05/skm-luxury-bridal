...
const JEWELLERY_CATALOG: JewelleryItem[] = [
  {
    ...
    image: "/images/portfolio/bridal-pink-saree-gold-jewellery.jpg",
  ...
  {
    id: "j2",
    name: "Muhurtham Ottiyanam (Waist Belt)",
    category: "Ottiyanam",
    priceTag: "Rental from ₹1,200 / event",
    image: "/images/portfolio/full-bridal-pose-silk-saree.jpg",
    description: "Handcrafted adjustable gold hip belt with ruby stone accents, perfect for silk saree drape waist tightening.",
    includes: ["Adjustable Hip Belt", "Velvet Storage Box", "Sanitized Padding"],
  },
  {
    id: "j3",
    name: "Traditional South Indian Long Braid Hair Set",
    category: "Hair & Maang Tikka",
    priceTag: "Rental from ₹1,500 / event",
    image: "/images/portfolio/traditional-south-indian-bride.jpg",
    description: "Complete 9-piece poola jada hair accessory set including Billai discs, Nethichutti, and Suryan-Chandran headpieces.",
    includes: ["9 Hair Billai Discs", "Suryan & Chandran", "Maang Tikka", "Jhumkas"],
  },
  {
    id: "j4",
    name: "HD Bridal Portrait Choker & Earring Set",
    category: "Antique Choker",
    priceTag: "Rental from ₹2,500 / event",
    image: "/images/portfolio/bridal-close-up-portrait.jpg",
    description: "Close-fitting antique gold choker set with uncut polki finish and matte gold pearls, ideal for reception glam.",
    includes: ["Uncut Polki Choker", "Matching Hanging Earrings", "Nose Ring (Nath)"],
  },
  {
    id: "j5",
    name: "Sparkling Zircon & Emerald Reception Set",
    category: "Zircon & Bridal Sets",
    priceTag: "Rental from ₹3,000 / event",
    image: "/images/portfolio/before-after-hd-makeover.jpg",
    description: "Modern American Diamond & Emerald green stone necklace set designed for evening reception gowns and designer sarees.",
    includes: ["AD Diamond Choker", "Drop Earrings", "Bracelet Hand Harness"],
  },
];
