            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  {serviceParam && !["Royal Bridal Package", "Classic Bridal Package", "Luxury Airbrush Grand Package", "Royal HD Makeover Package", "Luxury HD Bridal Makeup", "Airbrush Bridal Makeup", "Reception / Engagement Makeup", "Saree Draping & Hair Styling", "Jewellery Rental Service", "Custom Combo Package"].includes(serviceParam) && (
                    <option value={serviceParam}>{serviceParam}</option>
                  )}
                  <option value="Classic Bridal Package">Classic Bridal Package</option>
                  <option value="Royal HD Makeover Package">Royal HD Makeover Package</option>
                  <option value="Luxury Airbrush Grand Package">Luxury Airbrush Grand Package</option>
