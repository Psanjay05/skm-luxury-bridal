...
import { Eye, X, Sparkles, SlidersHorizontal } from "lucide-react";
import { Button } from "@/components/ui/button";

const CATEGORIES = ["All", "Before & After", "Bridal", "Jewellery", "Saree Draping"];
...
const GALLERY_ITEMS = [
  {
    ...
    subtitle: "Flawless Sweat-Proof HD Base, Lip & Eye Artistry by Maha Shree",
    image: "/images/portfolio/before-after-hd-makeover.jpg",
    span: "aspect-[4/3] sm:col-span-2",
  },
  {
    id: 2,
    category: "Bridal",
    title: "Outdoor Traditional South Indian Bride",
    subtitle: "Intricate Long Braid Hair Accessories & Antique Temple Gold",
  ...
  },
  {
    ...
    subtitle: "Layered Antique Necklaces & High Definition Finish",
  ...
  },
  {
    ...
    subtitle: "Pre-Pleated Silk Saree, Gold Waist Belt (Ottiyanam) & Styling",
  ...
  },
  {
    ...
    subtitle: "Maang Tikka, Temple Earrings & Soft Glam Glow",
    ...
    <div className="min-h-screen pt-28 pb-20 bg-background">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="text-center mb-14 space-y-4">
          ...
          <h1 className="font-heading text-5xl md:text-6xl font-medium tracking-tight">Our Masterpieces</h1>
          ...
          <AnimatePresence>
            {filteredItems.map((item) => (
              <motion.div
                ...
                className={`group relative bg-card border border-border/70 rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all cursor-pointer flex flex-col ${item.span}`}
              >
                {/* Image Container */}
                <div className="relative w-full h-full min-h-[360px] overflow-hidden bg-primary/5">
                  <Image
                    src={item.image}
                    alt={item.title}
                    fill
              ...
              >
                ...
                <div className="w-full md:w-1/2 flex flex-col justify-between py-2">
                  <div className="space-y-4">
                    ...
                    <h3 className="font-heading text-2xl md:text-3xl font-medium text-foreground">{selectedItem.title}</h3>
                    <p className="text-sm text-muted-foreground leading-relaxed">{selectedItem.subtitle}</p>
